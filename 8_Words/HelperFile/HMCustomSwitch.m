...
{
	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,96,27)]))
	{
...
-(void)awakeFromNib
{
	...
	[self setThumbImage:[UIImage imageNamed:@"thump.png"] forState:UIControlStateNormal];
	[self setMinimumTrackImage:[UIImage imageNamed:@"on.png"] forState:UIControlStateNormal];
	[self setMaximumTrackImage:[UIImage imageNamed:@"off.png"] forState:UIControlStateNormal];
	...
	self.clippingView = [[UIView alloc] initWithFrame:CGRectMake(4,2,90,25)]; //(4,2,87,23)
...
-(void)setTintColor:(UIColor*)color
{
	...
	//	tintColor = [color retain];
		...
		[self setMinimumTrackImage:[self image:[UIImage imageNamed:@"offbg.png"] tintedWithColor:tintColor] forState:UIControlStateNormal];
	}
